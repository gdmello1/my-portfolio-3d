...
const Contact = () => {
  ...
  const handleSubmit = (e: any) => {
    ...
    emailjs
      .send(
        ...
        {
          from_name: form.name,
          to_name: "Gavin Edwin D'Mello",
          from_email: form.email,
          to_email: "gavinedwindmello@gmail.com",
  ...
  const isDisabled =
    ...
    !form.message ||
    !form.name ||
    (form.email != null && form.email.length < 1) ||
    (form.message != null && form.message.length < 1) ||
    (form.name != null && form.name.length < 1);
